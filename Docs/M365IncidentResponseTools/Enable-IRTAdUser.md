...
```
Enable-IRTAdUser [[-UserObject] <psobject[]>] [<CommonParameters>]
```

## ALIASES

Enable-IRTAdUsers, Enable-AdUser, Enable-AdUsers, EnableIRTAdUser, EnableIRTAdUsers, EnableAdUser, EnableAdUsers, Unlock-IRTAdUser, Unlock-IRTAdUsers, Unlock-AdUser, Unlock-AdUsers, UnlockIRTAdUser, UnlockIRTAdUsers, UnlockAdUser, UnlockAdUsers
