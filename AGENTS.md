...
- `Docs/M365IncidentResponseTools/` — auto-generated by PlatyPS via `Docs.ps1`; do not edit directly.
...
- Use `Write-IRT` for user output in all in-domain code. Levels: `Info` (default),
   `Warn`, `Error`
