...
## SYNOPSIS
Requests service principals from Microsoft Graph.
Caches in global variable.

## SYNTAX

```
Request-GraphServicePrincipal [-Cached] [-Test] [[-Xml] <Boolean>] [[-Return] <String>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

## DESCRIPTION
Internal helper.
Fetches all Entra ID service principals from Microsoft Graph and
