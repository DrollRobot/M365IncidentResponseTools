...
## SYNOPSIS
Requests directory role templates from Microsoft Graph.
...
## DESCRIPTION
Internal helper.
Fetches all Entra ID directory role templates from Microsoft Graph
and caches the result in a session-scoped global variable.
Used alongside
