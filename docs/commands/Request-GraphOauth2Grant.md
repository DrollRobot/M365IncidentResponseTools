...
## SYNOPSIS
Requests OAuth2 permission grants from Microsoft Graph.
...
## DESCRIPTION
Internal helper.
Fetches all delegated OAuth2 permission grants from Microsoft Graph
and caches them in a session-scoped global variable keyed by client ID.
Used by
