...
### Search (Default)
```
Find-IRTAdUser [-Search] <String[]> [-VarPrefix <String>] [-Script] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### Clipboard
```
Find-IRTAdUser [-FromClipboard] [-VarPrefix <String>] [-Script] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
